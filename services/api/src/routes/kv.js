...
import { requireAdminApiKeyIfConfigured } from '../middleware/admin.js'
...
router.put('/kv/:collection/:key', requireAdminApiKeyIfConfigured, async (req, res) => {
...
router.get('/kv/:collection/:key', requireAdminApiKeyIfConfigured, async (req, res) => {
  const collection = req.params.collection
  const key = req.params.key
...
router.get('/kv/:collection', requireAdminApiKeyIfConfigured, async (req, res) => {
  const collection = req.params.collection
...
router.delete('/kv/:collection/:key', requireAdminApiKeyIfConfigured, async (req, res) => {
  const collection = req.params.collection
  const key = req.params.key
