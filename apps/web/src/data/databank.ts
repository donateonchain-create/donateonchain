...
export const campaigns: Campaign[] = [
  ...
  },
  {
    id: 7,
    image: Causeimg,
    title: "Girls in Tech Scholarship Fund",
    amountRaised: "₦300,000",
    goal: "₦1,000,000",
    percentage: 30,
    category: "education",
    deadline: new Date(Date.now() + 12 * 24 * 60 * 60 * 1000).toISOString(),
    about: "This campaign provides scholarships and laptops for girls from low-income communities to study technology, design, and engineering.",
    howItWorks: "Donations are pooled and awarded as scholarships each term. Partner schools help identify qualified candidates and report on progress.",
    useOfFunds: "60% funds tuition and exam fees, 25% buys laptops and study materials, 10% supports mentorship programs, 5% covers monitoring."
  },
  {
    id: 8,
    image: Causeimg,
    title: "Urban Food Garden Hubs",
    amountRaised: "₦650,000",
    goal: "₦1,200,000",
    percentage: 54,
    category: "climate-change",
    deadline: new Date(Date.now() + 16 * 24 * 60 * 60 * 1000).toISOString(),
    about: "Urban Food Garden Hubs convert unused city spaces into community gardens that provide fresh food and income for residents.",
    howItWorks: "Local partners secure land, install raised beds and irrigation, then train community members to maintain the gardens and sell surplus.",
    useOfFunds: "45% builds garden infrastructure, 30% buys seeds and tools, 15% goes to training, 10% supports community coordination and reporting."
  },
  {
    id: 9,
    image: Causeimg,
    title: "Maternity Care Access",
    amountRaised: "₦1,800,000",
    goal: "₦3,000,000",
    percentage: 60,
    category: "healthcare",
    deadline: new Date(Date.now() + 8 * 24 * 60 * 60 * 1000).toISOString(),
    about: "Maternity Care Access ensures pregnant women in rural areas can reach clinics, get checkups, and deliver safely.",
    howItWorks: "Donations subsidize transport vouchers, prenatal checkups, and basic delivery kits distributed through local clinics.",
    useOfFunds: "55% funds clinical services and kits, 25% covers transport vouchers, 15% trains midwives, 5% supports data tracking."
  },
  {
    id: 10,
    image: Causeimg,
    title: "Community Internet Learning Pods",
    amountRaised: "₦120,000",
    goal: "₦800,000",
    percentage: 15,
    category: "education",
    deadline: new Date(Date.now() + 6 * 24 * 60 * 60 * 1000).toISOString(),
    about: "Community Internet Learning Pods set up shared Wi‑Fi and small learning spaces so students can access online classes and resources.",
    howItWorks: "Routers, solar power, and basic furniture are installed in safe community locations where students can study after school.",
    useOfFunds: "50% covers connectivity and equipment, 20% funds solar power, 20% goes to space setup, 10% supports maintenance and security."
  }
]
