...
import Banner2Img from '../assets/banner2img.png'
import Banner1Img from '../assets/banner1img.png'
        ...
        <div className="flex flex-col">
            ...
            <section ref={sectionRef} className="w-full bg-white pt-40 pb-24 sm:pt-52 sm:pb-32 lg:pt-64 lg:pb-40">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <p className="text-center leading-tight font-medium text-4xl sm:text-5xl lg:text-[60px]">
                ...
                <div className="relative z-10 px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-12 lg:mb-16">
                        ...
                        <div className="flex items-center gap-6">
                            <a href="https://x.com/donateonchain" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#FFC33F] transition-colors">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                                </svg>
                            </a>
                            <a href="" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#FFC33F] transition-colors">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
